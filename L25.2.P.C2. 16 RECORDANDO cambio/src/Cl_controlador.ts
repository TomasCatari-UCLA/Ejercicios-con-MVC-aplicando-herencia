...
import { iFotografia } from './Cl_vFotografia.js';
import Cl_vTienda from './Cl_vTienda.js';
import { iVideo } from './Cl_vVideo.js';
...
export default class Cl_controlador {
    ...
    procesarFotografia(data: iFotografia) {
  ...
  reportarPromocion({ mPromocion }: { mPromocion: Cl_mPromocion }) {
