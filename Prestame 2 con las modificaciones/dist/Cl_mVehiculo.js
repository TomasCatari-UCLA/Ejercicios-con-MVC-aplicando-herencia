...
export default class Cl_mVehiculo extends Cl_mPrestamo {
    ...
    intereses() {
        if (this.modelo == "N" || this.modelo == "n") {
            return this.montoFinalP() * 0.12; //aa
        }
    ...
    interesNoP() {
        if (this.modelo == "N" || this.modelo == "n") {
            return this.interesOriginal() - this.intereses();
        }
        else
            return 0;
    }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), { modelo: this.modelo, interesNop: this.interesNoP() //aa
         });
    }
}
