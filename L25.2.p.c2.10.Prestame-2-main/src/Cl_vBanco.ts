...
export default class Cl_vBanco extends Cl_vGeneral {
  ...
  reportarPrestamo({ dataPrestamo,montoTotalPrestamos,montoTotalIntereses,porcentajeIntereses,}:
    {dataPrestamo:iPrestamo;montoTotalPrestamos: number;montoTotalIntereses: number;porcentajeIntereses: number;}): void {
    this.dataPrestamo.innerHTML += `
