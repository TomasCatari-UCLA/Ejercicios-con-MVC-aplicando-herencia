...
export default class Cl_vEmpresa extends Cl_vGeneral {
    ...
    reportarEmpleado({ dataEmpleado, prima, adicional, sueldoMensual, montoTotalPagado, montoAdicionalOperadores, montoAdicionalDirectivo, ReporteMayor, ConfirmacionDirectivos, ReporteBonos }) {
        this.dataEmpleados.innerHTML += `
