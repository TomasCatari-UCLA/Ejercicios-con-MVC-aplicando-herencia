...
export default class Cl_index {
    ...
    iniciarData() {
        ...
        this.controlador.procesarPolizaVehiculo(new Cl_mVehiculo(polizasVehiculos[0]));
        this.controlador.procesarPolizaVehiculo(new Cl_mVehiculo(polizasVehiculos[1]));
        this.controlador.procesarPolizaVehiculo(new Cl_mVehiculo(polizasVehiculos[2]));
    }
}
